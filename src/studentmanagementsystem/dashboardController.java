...
public class dashboardController implements Initializable {
    ...
    public void homeDisplayTotalEnrolledStudents() {
        ...
        try {
            ...
            if (result.next()) {
                // Sử dụng alias "total" để lấy giá trị
    ...
    public void homeDisplayFemaleEnrolled() {
        ...
        String sql = "SELECT COUNT(id) AS total FROM student WHERE gender = 'Female' AND status = 'Enrolled'";
    ...
    public void homeDisplayMaleEnrolled() {
        ...
        String sql = "SELECT COUNT(id) AS total FROM student WHERE gender = 'Male' AND status = 'Enrolled'";
    ...
    public void homeDisplayTotalEnrolledChart() {
        ...
        String sql = "SELECT date, COUNT(id) AS total FROM student WHERE status = 'Enrolled' GROUP BY date ORDER BY date ASC LIMIT 5";
    ...
    public void homeDisplayFemaleEnrolledChart() {
        ...
        String sql = "SELECT date, COUNT(id) AS total FROM student WHERE status = 'Enrolled' AND gender = 'Female' GROUP BY date ORDER BY date ASC LIMIT 5";
    ...
    public void homeDisplayEnrolledMaleChart() {
        ...
        String sql = "SELECT date, COUNT(id) AS total FROM student WHERE status = 'Enrolled' AND gender = 'Male' GROUP BY date ORDER BY date ASC LIMIT 5";
        ...
        try {
            ...
            if (addStudents_studentNum.getText().isEmpty()
                ...
                if (result.next()) {
                    ...
                    prepare.setString(2, (String) addStudents_year.getSelectionModel().getSelectedItem());
                    prepare.setString(3, (String) addStudents_course.getSelectionModel().getSelectedItem());
                    prepare.setFloat(4, 0);
                    prepare.setFloat(5, 0);
                    prepare.setFloat(6, 0);
